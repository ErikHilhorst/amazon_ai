...
output_filename_clean = "output_data/maps/amazon_research_areas_map_clean_with_town_corrected.html"
os.makedirs(os.path.dirname(output_filename_clean), exist_ok=True)
