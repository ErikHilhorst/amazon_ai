...
# --- Configuration ---
# Input TIFFs will now come from various new locations, defined in tiffs_to_visualize
# Output PNGs will go to "output_data/maps/"
output_maps_dir = "output_data/maps/"
...
tiffs_to_visualize = [
    {"input_path": "output_data/processed_dem/gee_srtm_aoi_wbt_compat.tif", "output_name": "gee_srtm_aoi_wbt_compat.png", "title": "WBT-Compatible DEM (Input)", "cmap": "terrain"},
    {"input_path": "output_data/processed_dem/filled_dem_wbt.tif", "output_name": "filled_dem_wbt.png", "title": "Filled DEM", "cmap": "terrain"},
    {"input_path": "output_data/intermediate_outputs/d8_pointer_wbt.tif", "output_name": "d8_pointer_wbt.png", "title": "D8 Flow Pointers", "cmap": "viridis"},
    {"input_path": "output_data/intermediate_outputs/facc_wbt.tif", "output_name": "facc_wbt.png", "title": "Flow Accumulation (Log Scale)", "cmap": "Blues", "log_scale_facc": True},
    {"input_path": "output_data/interfluves/streams_gee_wbt_final.tif", "output_name": "streams_gee_wbt_final.png", "title": "Final Extracted Streams", "is_binary": True},
    {"input_path": "output_data/interfluves/interfluves_by_distance_gee_wbt.tif", "output_name": "interfluves_by_distance_gee_wbt.png", "title": "Interfluves by Distance", "is_binary": True},
    {"input_path": "output_data/intermediate_outputs/tpi_gee_wbt.tif", "output_name": "tpi_gee_wbt.png", "title": "Topographic Position Index (TPI)", "cmap": "RdBu_r", "vmin_user":-2, "vmax_user":2},
    {"input_path": "output_data/interfluves/interfluves_by_tpi_gee_wbt.tif", "output_name": "interfluves_by_tpi_gee_wbt.png", "title": "Interfluves by TPI", "is_binary": True},
    {"input_path": "output_data/interfluves/combined_interfluves_gee_wbt.tif", "output_name": "combined_interfluves_gee_wbt.png", "title": "Combined Interfluves", "is_binary": True},
]

# --- Main Loop ---
if __name__ == "__main__":
    # output_maps_dir is defined in the Configuration section
    logger.info(f"Saving output images to: {output_maps_dir}")

    for item in tiffs_to_visualize:
        tiff_file_path = item["input_path"]
        output_png_path = os.path.join(output_maps_dir, item["output_name"])
