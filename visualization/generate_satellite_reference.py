...
# --- Configuration ---
reference_tiff_path = "output_data/processed_dem/gee_srtm_aoi_wbt_compat.tif"
# Fallback if the above is not yet created (e.g. during testing)
# reference_tiff_path = "input_data/dem/gee_srtm_aoi.tif" # If using the original GEE DEM

output_html_map = "output_data/maps/reference_satellite_map.html"
output_png_image = "output_data/maps/reference_satellite_image.png"
os.makedirs(os.path.dirname(output_html_map), exist_ok=True) # Ensures "output_data/maps" exists
